...
## Generate reports
### Download Files
Place both the base model [luodian/OTTER-MPT7B-Init](https://huggingface.co/luodian/OTTER-MPT7B-Init/tree/main).

Our instruction-tuned model hf folder [https://huggingface.co/Yuliiiiiiiione/i-CTPA/tree/main] at **./checkpoint/** folder
